...
selectAll.on("change",function(){
    if($(this).prop("checked")){
        ...
        $(".cart-checkbox>input[type=checkbox]").siblings().attr("disabled", false);
        $(".cart-checkbox").siblings().attr("disabled", false);
    }else{
        selectOne.prop("checked",false);
        $(".cart-checkbox>input[type=checkbox]").siblings().attr("disabled", true);
        $(".cart-checkbox").siblings().attr("disabled", true);
    }
    calCheckedCount();
    calCheckedPrice();
});
